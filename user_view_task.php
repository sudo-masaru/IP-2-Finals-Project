...
<head>
    ...
    <title>Fluttertask - view task</title>
    ...
    <link rel="stylesheet" href="user_view_task.css">
</head>
<body>
                                ...
                                <form method="POST">
                                    ...
                                    <div class="p-1 card-header bg-white d-flex flex-row justify-content-start align-items-center">
                                        ...
                                        <div class="border-0 w-100 d-flex justify-content-end pe-3">
                                            <button type="submit" name="edit-task" class="p-1 ps-3 pe-3 rounded-4" style="border: 1px solid #42B1F6; background-color: #42B1F6; color: #ffffff;">
                                                <i class="bi bi-pencil-square"></i>
                                                <span class="text-white btn-txt">Edit Task</span>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body p-0 pt-3 pb-3 d-flex flex-column justify-content-center align-self-center" style="gap: 1rem;">
                                        ...
                                        <div class="border-0" style="height: 3rem;">
                                            <button type="submit" name="create-new-task" class="w-100 h-100 p-0" style="border: 1px solid #FF0022; background-color: rgba(255, 0, 34, 0.1); color: #FF0022;">
                                                DELETE
                                            </button>
                                        </div>
