            ...
            <div class="row my-row h-100">
                    ...
                    <div class="my-main-content border-0 d-flex flex-column">
                        ...
                        <div class="CONTENT h-100 d-flex flex-column border-0 ps-3 pe-3">
                            ...
                            <div class="card border rounded-0">
                                ...
                                <div class="border-0 p-2 d-flex justify-content-center align-items-center w-100">
                                    
                                    <div class="card border-0 w-100 h-100">
                                        
                                        <div class="CAL-BOX card-body p-0">
                            ...
                            <div class="DISPLAY-TASKS border w-100 p-0">
                                ...
                                <form method="POST" class="w-100 h-100">
                                    ...
                                    <?php
                                        ...
                                        if(isset($DATE))
                                        {
                                            $sql_query_tasks="SELECT id, user_id, title, priority, status, DATE(created_at) AS created_date FROM tasks WHERE user_id='$id' AND created_at = '$DATE'";
                ...
                <div class="col-auto border my-sidebar bg-light p-0">
                   <form method="POST">
                        ...
                        <button type="submit" title="Users" value="<?php echo $id; ?>" name="calendar" class="active sidebar-nav border-0 d-flex flex-column justify-content-center">
