<?php
    ...
    {
        $currID = mysqli_real_escape_string($conn, $_GET['id']);
        $usrID = $_POST['account-deletion'];

        // echo "id: " . $currID . "<br> user id: ".$usrID;
                                  ...
                                  <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                      <form method="POST">
                                        ...
                                        <li><button class="dropdown-item" type="submit" value="<?php echo $id; ?>" name="home">Return</button></li>
                                ...
                                <form method="POST" class="w-100">
                                    ...
                                    <div class="card-body p-0 border-0 w-100 pt-3 pb-3">
                                        ...
                                        <!-- <div class="border-0 d-flex flex-row justify-content-end pe-3">
                                            <button type="submit" value="#" name="edit-profile" class="p-1 ps-3 pe-3 rounded-4" style="border: 1px solid #42B1F6; background-color: #42B1F6; color: #ffffff;">
                                        ...
                                        <!-- <div class="border-0 w-100 pt-3 pb-3 d-flex flex-column justify-content-center align-items-center">
                                            ...
                                            <div class="border d-flex justify-content-center align-items-center" style="overflow: hidden; width: 8rem; height: 8rem; border-radius: 50%;">
                                                <img src="#" alt="..." width="150rem" height="150rem">
                                            </div>
                                                ...
                                                if($result_user->num_rows > 0)
                                                {
                                                    while($row = $result_user->fetch_assoc())
                                                    {
                                                        ...
                                                        echo "
                                                            ...
                                                            <div class='border-0 d-flex flex-row justify-content-end pe-3'>
                                                                <button type='submit' value='$usrID' name='edit-profile' class='p-1 ps-3 pe-3 rounded-4' style='border: 1px solid #42B1F6; background-color: #42B1F6; color: #ffffff;'>
                                                                    <i class='bi bi-pencil-square'></i>
                                                                    <span class='text-white btn-txt'>Edit Profile</span>
                                                                </button>
                                                            </div>
                                                            ...
                                                            <div class='border-0 w-100 pt-3 pb-3 d-flex justify-content-center align-items-center'>
                                                                <button value='$usrID' type='submit' name='account-deletion' class='p-1 ps-3 pe-3 rounded-4' style='border: 1px solid #FF0022; background-color: rgba(255, 0, 34, 0.1);'>
                                                                    <i class='bi bi-trash text-danger'></i>
                                                                    <span class='text-danger'>Remove User</span>
                                                                </button>
                                                            </div>
                                                        ";
                                                    }
